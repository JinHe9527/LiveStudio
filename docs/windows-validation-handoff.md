...
> 2026-09-05 修复与验收见 [delivery-audit-2026-09-05.md](delivery-audit-2026-09-05.md)。目标版本 0.1.24；345 项 .NET 测试及 6 项依赖门测试通过；本机摄像头删除重建、7 阶段回滚和 2 项崩溃恢复通过。新增设备/模式/版本预检与小数帧率修复。跨实体采集卡 Verified=0；发布和安装状态以报告最终记录为准，不得将单机证据描述为全目标场景完整交付。
